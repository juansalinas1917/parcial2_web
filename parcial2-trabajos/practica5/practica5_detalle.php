...
<?php 
	...
	$registros = array(
		array("id" => 1, "nombre" => "fernando", "edad" => 25, "sexo" => "M"),
		array("id" => 2, "nombre" => "martin", "edad" => 35, "sexo" => "M"),
		array("id" => 3, "nombre" => "maylo", "edad" => 55, "sexo" => "F"),
		array("id" => 4, "nombre" => "pedro", "edad" => 19, "sexo" => "F"),
		array("id" => 5, "nombre" => "sebastian", "edad" => 89, "sexo" => "F"),
		array("id" => 6, "nombre" => "chamika", "edad" => 56, "sexo" => "M"),
	);
